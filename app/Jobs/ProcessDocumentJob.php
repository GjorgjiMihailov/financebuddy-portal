...
5. suggested_account_code: предложи КОНТРАПАРТИСКА сметка (НЕ 271 — тоа е сметката на банката)
   - За уплати од купувачи: 120 (Побарувања од купувачи)
   - За исплати кон добавувачи: 400 (Обврски кон добавувачи)
   - За плати: 430 (Обврски за плати)
   - За даноци: 450 или 433
   - За останато: избери најблиска сметка
