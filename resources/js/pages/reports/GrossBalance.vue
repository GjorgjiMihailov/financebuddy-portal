...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Бруто биланс', href: '/reports/gross-balance' },
        ],
    },
});
...
function submit() {
    router.get('/reports/gross-balance', { from: from.value, to: to.value }, { preserveState: true, preserveScroll: true });
}
...
<template>
    ...
    <div class="p-6 print:p-0">
        ...
        <div class="overflow-x-auto rounded-lg border bg-white p-6 print:rounded-none print:border-0 print:p-2">
            <ReportHeader title="Бруто Биланс" :company="company" :from="from" :to="to" />
