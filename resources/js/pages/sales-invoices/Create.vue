...
function submit() { form.post('/sales-invoices'); }
</script>

<template>
    <Head title="Нова излезна фактура" />
    <div class="p-6">
        <Card class="max-w-lg">
            <CardHeader><CardTitle>Нова излезна фактура</CardTitle></CardHeader>
            <CardContent>
                <form class="grid gap-4" @submit.prevent="submit">
                    ...
                    <div class="grid gap-1.5">
                        <Label>Клиент *</Label>
                        <Input v-model="form.client_name" placeholder="Назив на клиентот" />
                    ...
                    <div class="flex gap-3 pt-2">
                        ...
                        <Button type="button" variant="outline" @click="$inertia.visit('/sales-invoices')">Откажи</Button>
                    </div>
                </form>
            </CardContent>
        </Card>
